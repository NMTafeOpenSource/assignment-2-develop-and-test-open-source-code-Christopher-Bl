...
/**
 * Class used to create a list for the vehicle database to display
 * @author J187384
 */
public class VehicleTable {
    ...
    /**
     * Class constructor specifying data table
     * @param vehicleManufacturer
     * @param vehicleModel
     * @param vehicleYear
     * @param vehicleRegistrationNo
     * @param vehicleOdemeterReading
     * @param vehicleTankCapacity
     * @param vehicleJourney
     * @param vehicleServiceCount
     * @param vehicleTotalScheduledServices
     * @param vehicleLastServiceOdemeterKM
     */
